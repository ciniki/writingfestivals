...
function ciniki_writingfestivals_scheduleDivisionHistory($ciniki) {
    ...
    if( $args['field'] == 'division_date' ) {
        ...
        return ciniki_core_dbGetModuleHistoryReformat($ciniki, 'ciniki.writingfestivals', 'ciniki_writingfestival_history', $args['tnid'], 'ciniki_writingfestival_schedule_divisions', $args['scheduledivision_id'], $args['field'], 'date');
    }

    ciniki_core_loadMethod($ciniki, 'ciniki', 'core', 'private', 'dbGetModuleHistory');
    return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.writingfestivals', 'ciniki_writingfestival_history', $args['tnid'], 'ciniki_writingfestival_schedule_divisions', $args['scheduledivision_id'], $args['field']);
}
?>
