...
// -------
//
function ciniki_writingfestivals_scheduleSectionAdd(&$ciniki) {
    //
    ...
    $rc = ciniki_writingfestivals_checkAccess($ciniki, $args['tnid'], 'ciniki.writingfestivals.scheduleSectionAdd');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    $rc = ciniki_core_objectAdd($ciniki, $args['tnid'], 'ciniki.writingfestivals.schedulesection', $args, 0x04);
    if( $rc['stat'] != 'ok' ) {
