...
// </history>
//
function ciniki_writingfestivals_festivalHistory($ciniki) {
    //
    ...
    $rc = ciniki_writingfestivals_checkAccess($ciniki, $args['tnid'], 'ciniki.writingfestivals.festivalHistory');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
