...
// -------
//
function ciniki_writingfestivals_categoryHistory($ciniki) {
    //
    ...
    $rc = ciniki_writingfestivals_checkAccess($ciniki, $args['tnid'], 'ciniki.writingfestivals.categoryHistory');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
