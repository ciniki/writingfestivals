...
// <rsp stat='ok' />
//
function ciniki_writingfestivals_competitorUpdateNames(&$ciniki, $tnid, $festival_id, $competitor_id=0) {
    ...
    if( $rc['stat'] != 'ok' ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.writingfestivals.82', 'msg'=>'Registration not found', 'err'=>$rc['err']));
    }
    ...
    foreach($registrations as $registration) {
        ...
        if( $registration['rtype'] < 90 ) {
            ...
            if( count($update_args) > 0 ) {
                ...
                if( $rc['stat'] != 'ok' ) {
                    return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.writingfestivals.84', 'msg'=>'Unable to update name', 'err'=>$rc['err']));
                }
            }
